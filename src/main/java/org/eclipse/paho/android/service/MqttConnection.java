...
class MqttConnection implements MqttCallbackExtended {
	...
	private ComAlarmPingSender alarmPingSender = null;
	...
	public void connect(MqttConnectOptions options, String invocationContext,
		...
		try {
			...
			// if myClient is null, then create a new connection
				...
				alarmPingSender = new ComAlarmPingSender(service);
	...
	private void deliverBacklog() {
		Iterator<ComMessageStore.ComStoredMessage> backlog = service.messageStore
				.getAllArrivedMessages(clientHandle);
		while (backlog.hasNext()) {
			ComMessageStore.ComStoredMessage msgArrived = backlog.next();
