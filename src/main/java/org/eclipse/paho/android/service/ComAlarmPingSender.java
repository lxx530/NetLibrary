...
class ComAlarmPingSender implements MqttPingSender {
    ...
    private ComAlarmPingSender that;
    private PendingIntent pendingIntent;
    private volatile boolean hasStarted = false;

    public ComAlarmPingSender(MqttService service) {
        if (service == null) {
...
//        // 无网络连接时重新开关wifi
//        WifiManager wifiManager = (WifiManager) service.getApplicationContext().getSystemService(WIFI_SERVICE);
