 ...
 * consumer, {@link ComMessageStore#getAllArrivedMessages(String)} is used.
 * <li>When a clean session is started {@link #clearArrivedMessages(String)} is
 * used.
 * </ul>
 */
interface ComMessageStore {

	/**
	 * External representation of a stored message
	 */
	interface ComStoredMessage {
		/**
	 ...
	 */
	Iterator<ComStoredMessage> getAllArrivedMessages(String clientHandle);
