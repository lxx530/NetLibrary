...
/**
 * Implementation of the {@link ComMessageStore} interface, using a SQLite database
 * 
 */
class ComDatabaseMessageStore implements ComMessageStore {
	 ...
	 */
	public ComDatabaseMessageStore(MqttService service, Context context) {
	 ...
	 */
	@Override
	public Iterator<ComStoredMessage> getAllArrivedMessages(
			final String clientHandle) {
		return new Iterator<ComStoredMessage>() {
			private Cursor c;
	...
	private class DbStoredData implements ComStoredMessage {
