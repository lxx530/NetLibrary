...
import org.eclipse.paho.client.mqttv3.keep_alive.CustomKeepAliveManager;
...
public class ClientState {
    ...
    public MqttToken checkForActivity(IMqttActionListener pingCallback) throws MqttException {
        ...
        if (connected && this.keepAlive > 0) {
            ...
            CustomKeepAliveManager.sendAlarmBroadCast((int) (nextPingTime / 1000));
...
//		if (quiescing && actualInFlight == 0 && pendingFlows.size() == 0 && inFlightPubRels == 0 && callback.isQuiesced()) {
    ...
    protected void notifyReceivedAck(MqttAck ack) throws MqttException {
        ...
        if (token == null) {
            ...
            Log.i("AlarmPingSender", "ClientState MqttPingResp at " + System.currentTimeMillis());
